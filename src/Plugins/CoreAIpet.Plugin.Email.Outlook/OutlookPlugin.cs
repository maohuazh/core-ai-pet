...
namespace CoreAIpet.Plugin.Email.Outlook;

public class OutlookPlugin : IPlugin, IEmailProvider
{
    public string Id => "provider.email.outlook";
    public string Name => "Outlook";
    public string Version => "1.0.0";
    public string Icon => "assets/outlook.png";
    ...
    public Task LoadAsync(IPluginContext context) { return Task.CompletedTask; }
