...
namespace CoreAIpet.Plugin.Message.DingTalk;

public class DingTalkPlugin : IPlugin, IMessageProvider
{
    public string Id => "provider.message.dingtalk";
    public string Name => "钉钉";
    public string Version => "1.0.0";
    public string Icon => "assets/dingtalk.png";
