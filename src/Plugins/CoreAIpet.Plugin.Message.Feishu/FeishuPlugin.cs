...
namespace CoreAIpet.Plugin.Message.Feishu;

public class FeishuPlugin : IPlugin, IMessageProvider
{
    public string Id => "provider.message.feishu";
    public string Name => "飞书";
    public string Version => "1.0.0";
    public string Icon => "assets/feishu.png";
