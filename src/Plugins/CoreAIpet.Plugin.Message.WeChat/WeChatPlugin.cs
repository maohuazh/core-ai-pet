...
namespace CoreAIpet.Plugin.Message.WeChat;

public class WeChatPlugin : IPlugin, IMessageProvider
{
    public string Id => "provider.message.wechat";
    public string Name => "企业微信";
    public string Version => "1.0.0";
    public string Icon => "assets/wechat.png";
