...
namespace CoreAIpet.Plugin.Message.Teams;

public class TeamsPlugin : IPlugin, IMessageProvider
{
    public string Id => "provider.message.teams";
    public string Name => "Teams";
    public string Version => "1.0.0";
    public string Icon => "assets/teams.png";
