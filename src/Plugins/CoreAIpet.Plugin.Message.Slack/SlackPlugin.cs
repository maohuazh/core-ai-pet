...
namespace CoreAIpet.Plugin.Message.Slack;

public class SlackPlugin : IPlugin, IMessageProvider
{
    public string Id => "provider.message.slack";
    public string Name => "Slack";
    public string Version => "1.0.0";
    public string Icon => "assets/slack.png";
