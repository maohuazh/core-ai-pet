...
namespace CoreAIpet.Plugin.Email.IMAP;

public class ImapPlugin : IPlugin, IEmailProvider
{
    public string Id => "provider.email.imap";
    public string Name => "IMAP";
    public string Version => "1.0.0";
    public string Icon => "assets/imap.png";
