...
This capability implements Live2D motion playback. The system builds a motion group index at model load time, supports case-insensitive lookup by group name, random motion selection with repeat avoidance, and smooth fade transitions between motions.
