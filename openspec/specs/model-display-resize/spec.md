# Model Display Resize

## Purpose

This capability defines the display dimensions for the Live2D model character. The model is rendered in a square viewport (150×150 pixels by default) with proper projection, centering, and eye tracking coordinate mapping.
